...
if(isset($_GET['id'])){
	...
	$formId = $_GET['id'];
	$current_record =  get_record('cmanager_config', 'id', $formId);
	        ...
	        $.ajaxSetup({async:false});
	         $.post("ajax_functions.php", { type: 'page2addfield', fieldtype: 'textfield', formid: formId},
   				function(data) {
		     		...
		     		if(num == 1){
		     		 newdiv.innerHTML = '<b>'+textFieldTxt+':</b> <img src="../images/move_up_dis.gif" width="20" height="20" alt="move up" />  <a href="page2.php?id=' + formId + '&down=' + uniqueId + '"><img src="../images/move_down.gif" width="20" height="20" alt="move down" /></a>  <a href="page2.php?id=' + formId + '&del=' + uniqueId + '"><img src="../images/deleteIcon.png" width="20" height="20" alt="delete" /></a> <p></p><table><tr><td>'+leftTxt+':</td><td><input type="text" size="30" id="'+ uniqueId+'" onfocus="enableSave(\''+uniqueId+'_savebtn\');"></input></td></tr></table><input type="button" value="'+saveTxt+'" id="'+uniqueId+'_savebtn" disabled="disabled" onclick="saveFieldValue(' + uniqueId + ');"/>';
	       			}
...
//this branch is where you process validated data.
    print_header_simple($streditinga, '',
          ...
          print_header_simple($streditinga, '',
		    ...
		    "<a href=\"form_builder.php\">".get_string('formBuilder_name','block_cmanager')."</a> ->". get_string('formBuilder_p2_header','block_cmanager')."
		     $strnav $streditinga", $mform->focus(), "", false);
