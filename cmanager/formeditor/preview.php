...
class courserequest_form extends moodleform {
    ...
    function definition() {
		...
		$mform->addElement('html', '<p></p>&nbsp;&nbsp;&nbsp;<a href="form_builder.php">&lt ' . get_string('back','block_cmanager') . '</a><p></p>');
	   	...
	   	$mform->addElement('header', 'mainheader', get_string('formBuilder_previewHeader','block_cmanager'));
...
//this branch is where you process validated data.
 print_header_simple($streditinga, '',
		    ...
		    "<a href=\"../cmanager_admin.php\">".get_string('cmanagerDisplaySearchForm','block_cmanager')."</a> ->Preview Form
