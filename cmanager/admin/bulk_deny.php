		...
		require_once('../cmanager_email.php');
			...
			foreach($denyIds as $cid){
				...
				if($cid != 'null'){
							...
							$currentRecord =  get_record('cmanager_records', 'id', $cid);
						    ...
						    $replaceValues['[e_key]'] = '';
						    $replaceValues['[full_link]'] = 'http://moodle.itb.ie/blocks/cmanager/comment.php?id=' . $cid;
						    $replaceValues['[loc]'] = '';
						    $replaceValues['[req_link]'] = 'http://moodle.itb.ie/blocks/cmanager/view_summary.php?id=' . $cid;
