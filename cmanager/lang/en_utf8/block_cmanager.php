...
//cmanager_config.php
$string['administratorConfig'] = 'Administrator Config';
...
$string['statsConfigInfo'] = 'This section contains statistics on the current number of requests which have been made since the course manager module has been in use on this server.';
...
$string['namingConvetionInstruction'] = 'Course manager will set up your courses using a selected naming convention.';
...
$string['configure_EnrolmentKeyInstruction'] = 'Course manager can generate an automatic enrolment key or you may choose to prompt the user for an enrolment key of their choice. If you choose to prompt the user, a field for entering the enrolment key will be added to the first page of the request form.';
...
$string['configure_instruction1'] = 'Course manager settings allows you to set administrator emails for communication, set default emails, set course naming conventions and default course settings such as start date and enrolment key policy.';
$string['configure_instruction2'] = 'The request form is split over two pages. Page one will prompt the user for the shortname and long name of the course to be created. This link will allow you to name those fields and also enabe an optional course mode setting.';
$string['configure_instruction3'] = 'This allows you to configure the 2nd page of the request. On this page you can create form elements that must be completed by the user as part of the request process. While this information is not used by course manager, it will allow administrators to gather structured information on the request and aid in the decision making process.';
...
$string['email_sumLink'] = 'Full course manager request summary link';
...
$string['formBuilder_returntoCM'] = 'Return Course Manager';
...
//module_manager
$string['cmanager'] = 'CManager';
$string['cmanagerDisplay'] = 'Course Manager';
$string['cmanagerDisplaySearchForm'] = 'Configure Request Form - Page 1';
$string['cmanagerWelcome'] = 'Welcome to moodle course manager. Before requesting a new course, please check your local guidelines.';
...
$string['cmanagerEnrolmentInstruction'] = 'Course manager can generate an automatic enrolment key or you may choose to prompt the user for an enrolment key of their choice.';
...
$string['configure'] = 'Configure Course Manager';
...
$string['configurecoursemanagersettings'] = ' Configure Course Manager Settings';
