...
class courserequest_form extends moodleform {
	...
	$pendingList = get_recordset_select('cmanager_records', $select=$selectQuery, $sort='', $fields='*', $limitfrom='', $limitnum='');

   // If no records exist..
   if(empty($pendingList)){
      $mform->addElement('html', '<div align=center style="height:100px"><p></p>&nbsp;<p></p>Sorry, nothing pending!</div>');
   }
   ...
   foreach($pendingList as $rec){
	...
	<div id="existingrequest"> <div style="float:left; width:20px">
  ...
  //  trimmed down in time.
   ...
   // If no records exist.
   if(empty($pendingList)){
      $mform->addElement('html', '<center><div style="height:100px"><p></p>&nbsp;<p></p>'.get_string('noPending','block_cmanager').'</div></center>');
   }
